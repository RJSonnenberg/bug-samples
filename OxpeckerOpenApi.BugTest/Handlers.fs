...
let animals = [
    { Name = "Buddy"; Species = Some "Dog"; Age = Some 5; Vaccinated = true }
    { Name = "Mittens"; Species = Some "Cat"; Age = Some 3; Vaccinated = false }
    { Name = "Tweety"; Species = Some "Bird"; Age = None; Vaccinated = true }
    { Name = "Nemo"; Species = Some "Fish"; Age = Some 1; Vaccinated = false }
    { Name = "Rex"; Species = Some "Reptile"; Age = Some 4; Vaccinated = true }
    { Name = "Stitch"; Species = None; Age = None; Vaccinated = false }
]
    ...
    fun (ctx: HttpContext) ->
        task {
            let request =
                ...
                with
                | _ex -> { AnimalSearchRequest.Name = None; Species = None; Vaccinated = None } // In case of binding failure, return an empty search request
            let filteredAnimals =
                animals
                |> List.filter (fun a ->
                    let nameMatches =
